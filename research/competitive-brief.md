# Competitive brief — Kliente 360 (2026-05-22)

Brief de posicionamento para apoiar a definição de portfólio, copy e arquitetura de site. Recorte: 6 concorrentes locais distribuídos pelos 3 pilares.
...
#### Sottelli (boutique, Campinas/SP)
- **Tagline implícita**: "Especialistas em Salesforce".
- **Escala**: 180+ pessoas, 200+ clientes, 350+ projetos, CSAT 4.99.
- **Ofertas**: implementação, alocação, sustentação (AMS), body shop. Clouds: Sales, Service, Marketing. Vertical: manufatura, financeiro, agronegócio.
- **Metodologia nomeada**: "Sottelli Agile Methodology" (escopo aberto, sprints, alocação dedicada).
- **Tom**: técnico, sóbrio, foco em entrega. Pouca narrativa de IA — fraqueza estratégica em 2026.
- **Leitura**: é o concorrente que mais se parece com onde Kliente 360 está hoje. Diferenciar via **Data Cloud + Agentforce + viés data & IA**.

#### Everymind (mid/enterprise, agora Compasso UOL)
- **Tagline implícita**: "Especialista multi-cloud Salesforce".
- **Escala**: ~500 pessoas, 1100+ certificações, parceiro Summit, CSAT ~4.8. Crescimento projetado 50–60% a.a.
- **Ofertas**: implementação multi-cloud (Sales, Service, Marketing, Commerce), Tableau, Vlocity, Slack, licenciamento. Indústrias verticalizadas: consumer goods, financeiro, varejo.
- **Tom**: corporativo enterprise, releases na imprensa, narrativa de IA generativa "alinhada a processos Salesforce".
- **Leitura**: teto aspiracional. Não compete por preço, compete por relação executiva e cobertura. Kliente 360 não joga aqui — joga **abaixo dele, acima da Sottelli**.

### Pilar 2 — Data & Analytics

#### Somativa (boutique)
- **Posicionamento explícito**: "Boutique de Dados e IA" — termo cravado no nome.
...
- **Ofertas**: Data 360°, Data Platform, Data Warehouse/Lake, IA Generativa, governança, BI/Analytics, **Indicium AI Academy** (educação).
- **Diferenciais**: metodologia própria, framework "para resultado real", treinamento embarcado, R$ 6 bi declarados em impacto.
...
- **Escala**: 100+ pessoas, 289+ projetos, 15M+ usuários impactados. Clientes: Torra, Fisk, Febracis, Itaipu.
- **Ofertas**: web/mobile sob medida, integrações (ERPs/CRMs), automação (n8n), agentes GPT, IA, segurança, suporte 365. Setores variados (saúde, educação, logística, energia, público).
- **Tom**: comercial direto, ranqueamento (Clutch), copy "redução de risco + estabilidade".
- **Leitura**: ocupa "AI-first" no mid-market generalista. Kliente 360 pode diferenciar por **verticais escolhidos + ponte explícita Salesforce↔IA** (Mind não tem essa ponta).

#### CI&T (enterprise global)
- **Tagline atual**: "Technology Transformation Specialists" / "Navigate Change".
- **Escala**: 30+ anos, 100+ clientes globais, 3200+ certificados em IA.
- **Ativo proprietário**: **CI&T/Flow** — plataforma de IA generativa para dev (ganhos de 2x produtividade declarados, 80+ clientes implantados).
- **Ofertas**: estratégia, CX, dev de software, cloud, dados, IA generativa.
- **Tom**: bilíngue, releases globais, copy aspiracional ("hiper-produtividade").
- **Leitura**: teto aspiracional. Lição central: **ter um ativo nomeado** (Flow) muda o jogo da copy. Kliente 360 ganharia muito ao nomear um produto/framework próprio no pilar IA.

## 3. Mapa de posicionamento

```
            BOUTIQUE / PROXIMIDADE              MID / ENTERPRISE / ESCALA
Salesforce  Sottelli                            Everymind
Data        Somativa                            Indicium
IA          Mind Group                          CI&T
```
...
5. **Cases nomeados com números.** Padrão de mercado é depoimento genérico. Kliente 360 ganha citando clientes + métricas (delta de pipeline, redução de churn, etc.) — se houver autorização.

## 5. Recomendações para o portfólio e copy

### Estrutura de ofertas sugerida (3 pilares × 3 ofertas)
...
5. Tagline — preferência entre as 4 direções, ou quer outra rodada?

---

**Próximo passo no PLAN.md** (item 4): com essas respostas, redesenhar arquitetura de seções do site e travar a copy do hero + 3 pilares.
